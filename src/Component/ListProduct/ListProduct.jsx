...
function ListProduct() {
  ...
  const removeProduct = async (id) => {
    ...
    axios.post('http://localhost:4000/product/removeproduct', { id })
      .then((res) => {
        console.log(res);
        setGetProducts(prevProducts => prevProducts.filter(product => product._id !== id));
      })
      .catch((err) => console.log(err));
  };
  ...
  const updateProduct = (e) => {
    ...
    axios.put(`http://localhost:4000/product/updateproduct/${editProduct._id}`, editProduct)
      .then((res) => {
        console.log(res);
        setEditProduct(null);
        fetchdata();
