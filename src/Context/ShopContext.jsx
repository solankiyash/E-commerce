...
const ShopContextProvider = (props) => {
  ...
  const removeToCart = (product) => {
    ...
    if (existingProductIndex !== -1) {
      ...
      if (updatedCart[existingProductIndex].quantity > 0) {
        ...
        const newdata = updatedCart.filter((i) => i.quantity !== updatedCart[existingProductIndex].quantity)
        setCart(newdata);
      }
    }
  };
  ...
  const contextValue = { all_product,handelChange, MatchPromocode,cart, addToCart,removeToCart,getTotalAmount,getCartItemCount,promocodeValue,setPromocodeValue,promocode };
